...
openscad-nightly -D 'part="motor_mount"' -D 'model=6' -D 'fin_type=1' -o stl/29mm/motor_mount.stl janus.scad 
...
openscad-nightly -D 'part="parachute"' -D 'model=6' -o stl/29mm/parachute.stl janus.scad
openscad-nightly -D 'part="parachute_extension"' -D 'model=6' -o stl/29mm/parachute_extension.stl janus.scad
...
openscad-nightly -D 'part="coupler1"' -D 'model=6' -o stl/29mm/coupler1.stl janus.scad  
openscad-nightly -D 'part="coupler2"' -D 'model=6' -o stl/29mm/coupler2.stl janus.scad  
openscad-nightly -D 'part="coupler3"' -D 'model=6' -o stl/29mm/coupler3.stl janus.scad  
openscad-nightly -D 'part="coupler4"' -D 'model=6' -o stl/29mm/coupler4.stl janus.scad  
